...
**What it can't do**: no SDK call can save the camera's live state into
...
to be worth the extra surface area. Not pursuing it further for now.
...
Picture Profile's deeper sub-parameters beyond the slot selector.
